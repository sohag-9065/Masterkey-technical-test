    ...
    return (
        <div className="flex flex-col lg:flex-row justify-between card-side border-2 border-slate-200  w-full">
            ...
            <div className="card-body justify-end max-w-[300px] my-14">
                ...
                <div className="rating rating-lg text-[#FFAE5D]">
                    {
                        ratings.map(rating => <svg key={rating} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-8 h-8 mr-4 fill-current">
